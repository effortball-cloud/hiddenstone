...
(function (global) {
  ...
  const DICT = {
    ...
    ko: {
      ...
      /* --- 전적 · 기보 다시보기 --- */
      'lobby.recordHead': '내 전적',
      'lobby.recentHead': '최근 대국',
      'rec.games': '대국',
      'rec.wins': '승',
      'rec.losses': '패',
      'rec.winRate': '승률',
      'rec.localNote': '전적과 기보는 <b>이 브라우저에만</b> 저장됩니다. 다른 기기에서는 보이지 않고, 브라우저 기록을 지우면 함께 사라집니다.',
      'rec.chip': '{w}승 {l}패',
      'rec.modeAi': 'AI {level}',
      'rec.modeOnline': '온라인',
      'rec.empty': '아직 끝낸 대국이 없습니다. 한 판 두고 오면 여기에 기록이 남습니다.',
      'rec.watch': '다시보기',
      'rec.hotseat': '같은 기기 2인 (전적 미집계)',

      'replay.back': '← 로비',
      'replay.start': '베이스빌드 직후 — 아직 첫 수 전입니다',
      'replay.move': '{n}수 · {side} {coord}',
      'replay.movePass': '{n}수 · {side} 패스',
      'replay.kindHidden': '히든',
      'replay.kindScan': '스캔',
      'replay.kindProbe': '히든 발견',
      'replay.outcomeWin': '승',
      ...
      'illegal.ko': '패! 이미 나왔던 형태는 다시 만들 수 없습니다.',
    ...
    en: {
      ...
      /* --- Record & replay --- */
      'lobby.recordHead': 'YOUR RECORD',
      'lobby.recentHead': 'Recent games',
      'rec.games': 'games',
      'rec.wins': 'won',
      'rec.losses': 'lost',
      'rec.winRate': 'win rate',
      'rec.localNote': 'Your record and game files are stored <b>in this browser only</b>. They will not appear on another device, and clearing your browser data removes them.',
      'rec.chip': '{w}W {l}L',
      'rec.modeAi': 'AI {level}',
      'rec.modeOnline': 'Online',
      'rec.empty': 'No finished games yet. Play one and it will show up here.',
      'rec.watch': 'Replay',
      'rec.hotseat': 'Two players, one device (not counted)',

      'replay.back': '← Lobby',
      'replay.start': 'Right after Base Build — before the first move',
      'replay.move': 'Move {n} · {side} {coord}',
      'replay.movePass': 'Move {n} · {side} passes',
      'replay.kindHidden': 'Hidden',
      'replay.kindScan': 'Scan',
      'replay.kindProbe': 'Hidden found',
      'replay.outcomeWin': 'W',
      ...
      'illegal.ko': 'Ko — you cannot recreate a board position that already occurred.',
